...
public class TaskInstanceServiceTest {
    ...
    public void queryTaskListPaging() {
        ...
        taskInstanceService.queryTaskListPaging(loginUser, projectCode, 1, "", "",
                "test_user", "20200101 00:00:00", "2020-01-02 00:00:00", "", ExecutionStatus.SUCCESS, "192.168.xx.xx",
                1, 20);
        ...
        // "test_user", "2020-01-01 00:00:00", "2020-01-02 00:00:00", "", ExecutionStatus.SUCCESS, "192.168.xx.xx",
        // 1, 20);
        ...
        // Assert.assertEquals(Status.REQUEST_PARAMS_NOT_VALID_ERROR.getCode(), (int)
        // executorErrorStartDateRes.getCode());
        ...
        // Assert.assertEquals(Status.REQUEST_PARAMS_NOT_VALID_ERROR.getCode(), (int)
        // executorErrorEndDateRes.getCode());
    }
